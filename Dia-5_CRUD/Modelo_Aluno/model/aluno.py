...
class Aluno:
    ...
    def dadosUpdate(self):
        self.__dadosUpdate = ("nome='{}',endereco='{}',nascimento='{}',cidade='{}',uf='{}',cep='{}' where idaluno={}").format(self.nome, self.cep, self.idaluno)
    ...
    @property
    def idaluno(self):
        return self.__idstudenta

    @idaluno.setter
    def idaluno(self, entrada):
        self.__idstudenta = entrada
